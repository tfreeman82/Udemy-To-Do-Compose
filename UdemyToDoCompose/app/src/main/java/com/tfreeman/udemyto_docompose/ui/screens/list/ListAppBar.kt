package com.tfreeman.udemyto_docompose.ui.screens.list
...
import com.tfreeman.udemyto_docompose.components.DisplayAlertDialog
...
fun SearchAppBar(
    ...
    var trailingIconState by remember { mutableStateOf(TrailingIconState.READY_T0_DELETE) }
                ...
                IconButton(
                    onClick = {
                        when (trailingIconState) {
                            TrailingIconState.READY_T0_DELETE -> {
                                onTextChange("")
                            ...
                            TrailingIconState.READY_TO_CLOSE -> {
                                if (text.isNotEmpty()) {
                                    ...
                                    onCloseClicked()
                                    trailingIconState = TrailingIconState.READY_T0_DELETE
                                }
